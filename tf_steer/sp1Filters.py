...
def sp1Filters():
    ''' Steerable pyramid filters.  Transform described  in:
        ...
        @INPROCEEDINGS{Karasaridis96,
            ...
            MONTH = "May",	YEAR = 1996 }  '''
    filters = {}
    filters['harmonics'] = tf.constant([ 1 ], dtype=tf.float64)
    filters['mtx'] = tf.constant([[1,0],
                                 [0,1]], dtype=tf.float64)
    filters['lo0filt'] = ( 
        tf.constant([[-8.701000e-05, -1.354280e-03, -1.601260e-03, -5.033700e-04, 
                  ...
                  [-8.701000e-05, -1.354280e-03, -1.601260e-03, -5.033700e-04, 
                    2.524010e-03, -5.033700e-04, -1.601260e-03, -1.354280e-03, 
                    -8.701000e-05]], dtype=tf.float64) )
    filters['lofilt'] = (
        tf.constant([[-4.350000e-05, 1.207800e-04, -6.771400e-04, -1.243400e-04, 
                  ...
                  [-4.350000e-05, 1.207800e-04, -6.771400e-04, -1.243400e-04, 
                    ...
                    1.262000e-03, -4.202000e-04, -2.516800e-04, -1.597040e-03,
                    -8.006400e-04, -1.243400e-04, -6.771400e-04, 1.207800e-04,
                    -4.350000e-05] ], dtype=tf.float64) )
    filters['hi0filt'] = (
        tf.constant([[-9.570000e-04, -2.424100e-04, -1.424720e-03, -8.742600e-04, 
                  ...
                  [-9.570000e-04, -2.424100e-04, -1.424720e-03, -8.742600e-04, 
                    -1.166810e-03, -8.742600e-04, -1.424720e-03, -2.424100e-04,
                    -9.570000e-04]], dtype=tf.float64) )
    filters['bfilts'] = (
        tf.transpose(tf.constant([[6.125880e-03, -8.052600e-03, -2.103714e-02, -1.536890e-02, 
                  ...
                  [-6.125880e-03, 1.287416e-02, 5.641530e-03, 8.957260e-03, 
                    ...
                    -6.125880e-03, 1.287416e-02, 5.641530e-03, 8.957260e-03, 
                    0.000000e+00, -8.957260e-03, -5.641530e-03, -1.287416e-02, 
                    6.125880e-03]], dtype=tf.float64) ))
    filters['bfilts'] = tf.math.negative(filters['bfilts'])
