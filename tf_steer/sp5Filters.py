...
def sp5Filters():
    ...
    filters = {}
    filters['harmonics'] = tf.constant([1, 3, 5], dtype = tf.float64)
    filters['mtx'] = (
        tf.constant([[0.3333, 0.2887, 0.1667, 0.0000, -0.1667, -0.2887],
                  ...
                  [-0.0000, 0.1667, -0.2887, 0.3333, -0.2887, 0.1667]], dtype = tf.float64))
    filters['hi0filt'] = (
        tf.constant([[-0.00033429, -0.00113093, -0.00171484,
                  ...
                  [-0.00033429, -0.00113093, -0.00171484,
                    -0.00133542, -0.00080639, -0.00133542,
                    -0.00171484, -0.00113093, -0.00033429]], dtype = tf.float64))
    filters['lo0filt'] = (
        tf.constant([[0.00341614, -0.01551246, -0.03848215, -0.01551246,
                  0.00341614],
                 ...
                 [0.00341614, -0.01551246, -0.03848215, -0.01551246,
                  0.00341614]], dtype = tf.float64))
    filters['lofilt'] = (
        2 * tf.constant([[0.00085404, -0.00244917, -0.00387812, -0.00944432,
                      ...
                      [0.00085404, -0.00244917, -0.00387812, -0.00944432,
                       -0.00962054, -0.00944432, -0.00387812, -0.00244917,
                       0.00085404]], dtype = tf.float64))
    filters['bfilts'] = (
        tf.transpose(tf.constant([[0.00277643, 0.00496194, 0.01026699, 0.01455399, 0.01026699,
